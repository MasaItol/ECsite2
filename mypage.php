...
<div id="contents" class="site-width">
    ...
    <section id="main">
        <section class="list panel-list">
            ...
            ?>
            <div class="product-list-zone" style="display: flex; flex-wrap:wrap;">
            <a href="registProduct.php<?php echo (!empty(appendGetParam())) ? appendGetParam().'&p_id='.$val['id'] : '?p_id='.$val['id']; ?>" class="panel">
                <div class="container-panel" style="">
                    ...
                    <div class="panel-head" style="">
                        <img src="<?php echo showImg(sanitize($val['pic1'])); ?>" alt="<?php echo sanitize($val['name']); ?>" style="width:200px; height:160px;">
                    <div>
                    <div class="panel-body">
                        <p class="panel-title"><?php echo showImg(sanitize($val['name'])); ?> <span class="price">¥<?php echo sanitize(number_format($val['price'])); ?></span></p>
                    </div>
                </div>
                ...
                <tbody>
                    ...
                    ?>
                                <tr>
                                    ...
                                    <td><?php echo $u_id; //echo sanitize($partnerUserInfo['username']); ?></td>
